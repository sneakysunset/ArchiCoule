...
public class MovementInput : MonoBehaviour {
	...
	private float groundcheckvalue;
    ...
    void Update () {
		...
		groundcheckvalue += Time.deltaTime;
...
/*        moveVector = new Vector3(0, verticalVel * .2f * Time.deltaTime, 0);
		...
		if (Input.GetKeyDown(KeyCode.Space) && groundcheckvalue < .5f)
		// (-0.5) change this value according to your character y position + 1
		{
			velocity.y = jump;
		}
		else if (groundcheckvalue >= .5f)
		{
